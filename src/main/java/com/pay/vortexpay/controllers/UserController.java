...
public class UserController {
    ...
    @Operation(summary = "Update user", description = "Allows partial updates to the user profile. If a new password is provided, it is automatically hashed using BCrypt before being persisted in the database.")
    @PutMapping("/{id}")
